...
class Test_Native_Rule_Engine_Plugin(resource_suite.ResourceBase, unittest.TestCase):
    ...
    def test_api_plugin(self):
        self.helper_test_pep(rule_texts[self.instance_name][self.class_name]['test_api_plugin'], "iapitest", ['pep_api_rs_hello_world_pre - api_instance auth_scheme=native', 'that=hello, world.++++this=42, null_value', 'HELLO WORLD', 'pep_api_rs_hello_world_post - api_instance auth_scheme=native', 'that=hello, world.++++this=42, that=hello, world.++++this=42++++value=128'])
