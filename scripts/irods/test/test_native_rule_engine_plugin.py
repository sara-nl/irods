...
class Test_Native_Rule_Engine_Plugin(resource_suite.ResourceBase, unittest.TestCase):
    ...
    def test_api_plugin(self):
        self.helper_test_pep(rule_texts[self.plugin_name][self.class_name]['test_api_plugin'], "iapitest", ['pep_api_rs_hello_world_pre -', ', null_value', 'HELLO WORLD', 'pep_api_rs_hello_world_post -', '128'])
